[Ivy]
[>Created: Tue Feb 21 00:29:44 CET 2017]
15A5DC43DD41540F 3.19 #module
>Proto >Proto Collection #zClass
Tg0 yesno_Terminvereinbarung_Professor Big #zClass
Tg0 B #cInfo
Tg0 #process
...
Tg0 @EMail f11 '' #zField
Tg0 @PushWFArc f12 '' #zField
Tg0 @PushWFArc f13 '' #zField
>Proto Tg0 Tg0 yesno_Terminvereinbarung_Professor #zField
...
Tg0 f11 beanConfig '"{/emailSubject ""bitte neuen Termin vorschlagen""/emailFrom ""pasingh-htwg@hotmail.de""/emailReplyTo ""gering.eugen@gmail.com""/emailTo ""gering.eugen@gmail.com""/emailCC """"/emailBCC """"/exceptionMissingEmailAttachments ""false""/emailMessage ""Bitte neuen Termin vorschlagen.""/emailAttachments * }"' #txt
Tg0 f11 type mein.projekt.Data #txt
Tg0 f11 timeout 0 #txt
Tg0 f11 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>neuen Termin vorschlagen
</name>
        <nameStyle>25
</nameStyle>
    </language>
...
' #txt
Tg0 f11 808 74 176 44 -68 -16 #rect
Tg0 f11 @|EMailIcon #fIcon
Tg0 f12 expr in #txt
Tg0 f12 outCond 'in.akzeptiereTermin == false' #txt
Tg0 f12 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>no</name>
        <nameStyle>2
...
' #txt
Tg0 f12 896 272 896 118 #arcP
Tg0 f13 expr out #txt
Tg0 f13 808 96 680 162 #arcP
Tg0 f13 1 680 96 #addKink
Tg0 f13 0 0.7608036758141423 0 0 #arcLabel
...
Tg0 f8 out f12 tail #connect
Tg0 f12 head f11 mainIn #connect
Tg0 f11 mainOut f13 tail #connect
Tg0 f13 head f9 mainIn #connect
